  ...
  return (
    <div className="grid w-full grid-cols-4 grid-flow-dense gap-4 font-normal text-xl gap-8 gap-x-5 gap-y-16 md:gap-y-6  md:grid-cols-1 text-lg">
      ...
      <div className="md:col-start-1 col-start-2 col-span-3">
        <h1 className="text-6xl md:text-2xl text-left font-light content_animate z-10 relative">
          Designer & art director creating scalable design solutions in
          branding, packaging and web design, striving for clarity, simplicity &
          logic.
        </h1>
      </div>
    </div>
