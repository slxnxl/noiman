...
export default function InfoBlockGrid() {
  return (
    <div className="grid grid-cols-4 gap-4 font-normal text-xl gap-8 gap-x-5 gap-y-16 md:gap-y-6 grid-flow-dense md:grid-cols-1 text-lg">
      ...
      <p className="">
        Bella Noiman <br /> Designer / Art director
        <br />
        <br />
        hello@bellanoiman.com
      </p>
      <p>
        I use design as a tool to improve businesses. My aim is to deliver
        meaningful and intelligent of digital products.
      </p>
